...
public class ChallengeSettingsController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		difficultySlider.valueProperty().addListener((observable, oldValue, newValue) -> {
			...
			switch (num) {
				case 1: howDifficult.setText("Beginner"); break;
				case 2: howDifficult.setText("Easy"); break;
				case 3: howDifficult.setText("Medium"); break;
				case 4: howDifficult.setText("Hard"); break;
				case 5: howDifficult.setText("A true challenge"); break;
			}
		});
	}
